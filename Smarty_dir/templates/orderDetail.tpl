...
<div id="details" class="container-fluid" style="margin-top: 50px">
  ...
  <div class="row" style="height: 500px">
    ...
    <div class="col-sm-5 text-center" style="right: 4.1%; margin-top: 1.5%">
      <p class="text-center"> <h1><strong>{$item}</strong></h1></p>
        <hr>
        <div class="text-left">
            <h3>Description: <h4> {$description}</h4></h3>
            <h3>Stock expiration:  22 days left</h3>

            <h3>Quantity per Lot: {$qty}</h3>
            <h3>price : {$ucost}&#8364;</h3>
            <h3 style="color: #6d90b5">Stocks available: {$avQty}</h3>
            <hr>
        </div>
</div>
